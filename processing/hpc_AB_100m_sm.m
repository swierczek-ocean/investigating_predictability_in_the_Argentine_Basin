...
hFacC = rdmds('../MITgcm/verification/AB3_01_init/run/hFacC');
hFacW = rdmds('../MITgcm/verification/AB3_01_init/run/hFacW');
hFacS = rdmds('../MITgcm/verification/AB3_01_init/run/hFacS');
DXG = rdmds('../MITgcm/verification/AB3_01_init/run/DXG');
DYG = rdmds('../MITgcm/verification/AB3_01_init/run/DYG');
XC = rdmds('../MITgcm/verification/AB3_01_init/run/XC');
YC = rdmds('../MITgcm/verification/AB3_01_init/run/YC');
RAC = squeeze(rdmds('../MITgcm/verification/AB3_01_init/run/RAC'));
RC = squeeze(rdmds('../MITgcm/verification/AB3_01_init/run/RC'));
RF3 = squeeze(rdmds('../MITgcm/verification/AB3_01_init/run/RF'));
DRF = rdmds('../MITgcm/verification/AB3_01_init/run/DRF');
...
save sSST3_100m sst3*
save sSSS3_100m sss3*
save sDIC3_100m dic3*
save sDO3_100m do3*
save sNO3_100m no3*
...
save sCHL3_100m chl3*
save sNCP3_100m ncp3*
save sNPP3_100m npp3*
save sPOC3_100m poc3*
...
hFacC = rdmds('../MITgcm/verification/AB12_01_init/run/hFacC');
RAC = squeeze(rdmds('../MITgcm/verification/AB12_01_init/run/RAC'));
DRF = rdmds('../MITgcm/verification/AB12_01_init/run/DRF');
