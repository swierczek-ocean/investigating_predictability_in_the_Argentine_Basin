...
INCLUDES='-I/opt/ohpc/pub/apps/netcdf-intel/4.7.4/include -I/opt/ohpc/pub/apps/netcdf-fortran/4.5.3/include -I/opt/ohpc/pub/compiler/intel_2020_u4/compilers_and_libraries/linux/mpi/intel64/include'
LIBS='-L/opt/ohpc/pub/apps/netcdf-intel/4.7.4/lib -L/opt/ohpc/pub/apps/netcdf-fortran/4.5.3/lib -lnetcdff -lnetcdf -L/opt/ohpc/pub/compiler/intel_2020_u4/compilers_and_libraries/linux/mpi/intel64/lib'
